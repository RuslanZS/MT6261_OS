...
#define GPIO_DATAIN(Pin) (((Pin) < 0x20) ? ((GPIO_DIN0 & (1UL << (Pin))) ? true : false) : ((Pin) < 0x40) ? ((GPIO_DIN1 & (1UL << ((Pin)-0x20))) ? true : false) : false)
...
#define GPIO_SMTENABLE(Pin)                          \
    ...
    {                                                \
        ...
        {                                            \
            v = 1UL << (p - 0x20);                   \
            if (v & GPIO_SMT1_MASK)                  \
                GPIO_SMT1_SET = (1UL << (p - 0x20)); \
        }                                            \
    } while (0)
#define GPIO_SMTDISABLE(Pin)                         \
    do                                               \
    {                                                \
        uint32_t p = (Pin), v;                       \
        if (p < 0x20)                                \
...
#define GPIO_SETINPUTEN(Pin)                         \
    ...
    {                                                \
        ...
        {                                            \
            v = 1UL << (p - 0x20);                   \
            if (v & GPIO_IES1_MASK)                  \
                GPIO_IES1_SET = (1UL << (p - 0x20)); \
        }                                            \
    } while (0)
#define GPIO_SETINPUTDIS(Pin)                        \
    do                                               \
    {                                                \
        uint32_t p = (Pin), v;                       \
        if (p < 0x20)                                \
