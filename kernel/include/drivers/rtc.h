...
bool RTC_LockBBPower(void);
bool RTC_UnlockBBPower(void);
bool RTC_EnablePowerUp(void);
bool RTC_DisablePowerUp(void);
bool RTC_IsValidState(void);
bool RTC_IsAlarmActive(void);
bool RTC_Initialize(void);
TDATETIME RTC_GetDateTime(void);
bool RTC_SetTime(pTIME Time);
bool RTC_SetDate(pDATE Date);
TDATETIME RTC_GetAlarmDateTime(void);
bool RTC_SetAlarmDateTime(pDATETIME DateTime, bool UseInterrupt);
void RTC_Sleep(void);
