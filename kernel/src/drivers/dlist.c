...
pDLIST DL_Delete(pDLIST DList, bool FreeData)
{
    uint32_t intflags;
...
bool DL_DeleteItemByData(pDLIST DList, void *Data)
{
    bool  Result = false;
    uint32_t intflags = DisableInterrupts();
    pDLITEM  tmpItem;
...
bool DL_DeleteItemByIndex(pDLIST DList, uint32_t Index)
{
    bool  Result = false;
    uint32_t intflags = DisableInterrupts();
    pDLITEM  tmpItem;
...
bool DL_MoveItemToIndex(pDLIST DList, uint32_t OldIndex, uint32_t NewIndex)
{
    bool  Result = false;
    uint32_t intflags;
