...
static bool GPT_IsPoweredUp(void)
{
...
static bool GPT_RegisterInterrupt(void)
{
#ifdef USEINTERRUPTS
...
static bool GPT_TryUnregisterInterrupt(void)
{
...
bool GPT_StartTimer(TGPT Index)
{
    bool Result = false;
...
bool GPT_SetupTimer(TGPT Index, uint16_t Frequency, bool Arepeat, void (*Handler)(void), bool Start)
{
    bool  Result = false;
    uint32_t GPTValue;
